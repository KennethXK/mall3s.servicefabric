...
using Mall3s.System.Entitys.Dto.System.Database;
using Mall3s.System.Entitys.Model.System.DataBase;
...
    /// </summary>
    public class DataBaseCoreService : IDataBaseCoreService
    {
        ...
        private readonly IAuthorizeCoreService _authorizeService;
        ...
        public DataBaseCoreService(ISqlSugarRepository<UserEntity> sqlSugarRepository, IDbLinkCoreService dbLinkService, IUserCoreManager userManager, IAuthorizeCoreService authorizeService)
        {
        ...
        public string ToConnectionString(DbLinkEntity dbLinkEntity)
        {
            switch (dbLinkEntity.DbType.ToLower())
            {
                ...
                default:
                    throw Mall3sException.Oh(ErrorCode.D1505);
            }
        }
            ...
            try
            {
                ...
                foreach (var item in tableFieldList)
                {
                    if (item.primaryKey == 1 && item.allowNull == 1)
                        throw Mall3sException.Oh(ErrorCode.D1509);
