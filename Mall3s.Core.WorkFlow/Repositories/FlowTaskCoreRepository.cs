...
using Mall3s.WorkFlow.Entitys.Dto.FlowLaunch;
using Mall3s.WorkFlow.Entitys.Dto.FlowMonitor;
using SqlSugar;
using System;
...
namespace Mall3s.Core.WorkFlow.Repositories
{
    /// <summary>
    /// 流程任务
    /// 版 本：V3.2
...
    /// 日 期：2021-06-01 
    /// </summary>
    public class FlowTaskCoreRepository : IFlowTaskCoreRepository, ITransient
    {
